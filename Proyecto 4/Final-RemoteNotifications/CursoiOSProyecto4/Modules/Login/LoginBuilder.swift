...
class NotificationsActionHandler: NotificationsProviderOutputContract {
...
class LoginBuilder {
    ...
    static func build() -> LoginView {
        ...
        let notificationProvider = NotificationsProvider(outputNotifications: NotificationsActionHandler())
        let interactor = LoginInteractor(biometricProvider: biometricProvider,
